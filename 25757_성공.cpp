...
int main()
{
    ...
    // unique(name.begin(), name.begin() + N);
    // name.erase( unique(name.begin(), name.begin() + N), name.end());
    // name.resize(distance(name.begin(), unique(name.begin(), name.begin() + N) ));
    ...
    int total = distance(name.begin(), unique(name.begin(), name.begin() + N));
    cout << total/players;
